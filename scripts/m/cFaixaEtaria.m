let
    ...
    #"Linhas Filtradas" = Table.SelectRows(#"Preenchido Abaixo", each ([Column1] = "TP_FAIXA_ETARIA")),
    #"Outras Colunas Removidas" = Table.SelectColumns(#"Linhas Filtradas",{"Column3", "Column4"}),
    #"Colunas Renomeadas" = Table.RenameColumns(#"Outras Colunas Removidas",{{"Column3", "TP_FAIXA_ETARIA"}, {"Column4", "Faixa Etária"}}),
    #"Tipo Alterado" = Table.TransformColumnTypes(#"Colunas Renomeadas",{{"TP_FAIXA_ETARIA", Int64.Type}, {"Faixa Etária", type text}})
in
    #"Tipo Alterado"