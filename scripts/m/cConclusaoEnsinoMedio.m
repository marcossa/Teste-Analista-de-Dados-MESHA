let
    ...
    #"Linhas Filtradas" = Table.SelectRows(#"Preenchido Abaixo", each ([Column1] = "TP_ANO_CONCLUIU")),
    #"Outras Colunas Removidas" = Table.SelectColumns(#"Linhas Filtradas",{"Column3", "Column4"}),
    #"Colunas Renomeadas" = Table.RenameColumns(#"Outras Colunas Removidas",{{"Column3", "TP_ANO_CONCLUIU"}, {"Column4", "Conclusão Ensino Médio"}}),
    #"Tipo Alterado" = Table.TransformColumnTypes(#"Colunas Renomeadas",{{"TP_ANO_CONCLUIU", Int64.Type}, {"Conclusão Ensino Médio", type text}})
in
    #"Tipo Alterado"